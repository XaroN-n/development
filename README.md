...
* Windows:
  ...
  * Download Impulse
  * Open cmd or powershell in xaron directory
  * Run this command: `pip install -r requirements.txt`
  * And this: `python xaron.py --help`

* Linux:
  * `sudo apt update`
  * `sudo apt install python3 python3-pip git -y`
  * `git clone https://github.com/XaroN-n/development`
  * `cd xaron/`
  * `pip3 install -r requirements.txt`
  * `python3 xaron.py --help`
...
```python3 xaron.py --method SMS --time 20 --threads 15 --target +380123456789```
